...
const Page = ({ params }) => {
  ...
  const handleSignup = () => {
    const businessId = currentBusiness && currentBusiness._id && currentBusiness._id.$oid;
    const userData = {
      name: name,
      email: signupEmail,
      phone: phone,
        ...
        <main className="w-full ">
          ...
          <div className="w-full  flex flex-row h-[7%] border-b-[1px] border-b-lightborder dark:border-b-darkborder justify-between">
            ...
            <div className="flex flex-row select-none items-center space-x-2 pr-5 text-lightbg dark:text-darktext">
              {customer && hasMounted ? (
                <div>
                  <button onClick={handleLogout} className="text-violet11 shadow-blackA4 hover:bg-mauve3 inline-flex h-[35px] items-center justify-center rounded-[4px] bg-palettePrimary px-[15px] font-medium leading-none shadow-[0_2px_10px] focus:shadow-[0_0_0_2px] focus:shadow-black focus:outline-none">Logout</button>
                </div>
              ) : (
                <div className="flex flex-row select-none items-center space-x-2 pr-5 text-lightbg dark:text-darktext">
                  <div className="p-[1%] ">
